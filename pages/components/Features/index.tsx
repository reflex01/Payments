...
const featuresdata: featuresdata[] = [
    ...
    },
    {
        ...
        heading: 'Free to use',
        subheading: 'No hidden fees. No Setup fees. Only pay when you process',
    },
    {
        imgSrc: '/images/Features/featureThree.svg',
        heading: 'AI Integration',
        subheading: 'AI customer support and AI fraud detection, 24/7 support',
    },
]
        ...
        <div className="mx-auto max-w-7xl my-0 md:my-40 pt-36 px-6 relative" id="features-section">
            ...
            <div className="grid lg:grid-cols-2 gap-x-4 gap-y-4">
                ...
                <div>
                    ...
                    <h2 className="text-offwhite text-3xl lg:text-5xl font-semibold leading-snug mb-6 text-center md:text-start">The most advanced payment processing platform</h2>
                    <p className="lg:text-lg font-normal text-bluish text-center md:text-start">Revolutionize Your Transactions: AI-Driven Support and Security.</p>
                </div>
                {/* Column-2 */}
                <div>
